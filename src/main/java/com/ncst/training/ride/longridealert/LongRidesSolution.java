...
public class LongRidesSolution {
    ...
    public static void main(String[] args) throws Exception {
        LongRidesSolution job = new LongRidesSolution(new TaxiRideGenerator(), new PrintSinkFunction<>());
        job.execute();
    }
    ...
    public static class AlertFunction extends KeyedProcessFunction<Long, TaxiRide, Long> {
        ...
        public void open(Configuration config) {
            ValueStateDescriptor<TaxiRide> rideStateDescriptor = new ValueStateDescriptor<>("ride event", TaxiRide.class);
